...
namespace nts {
    Component4081::Component4081(std::string const &name) : AComponent(name)
    {
    ...
    nts::Tristate Component4081::compute(std::size_t pin)
    {
        ...
        case 2:
            ...
            _pins[2].setState(Gates::andGate(_pins[0].getState(), _pins[1].getState()));
        ...
        case 3:
            ...
            _pins[3].setState(Gates::andGate(_pins[4].getState(), _pins[5].getState()));
        ...
        case 9:
            ...
            _pins[9].setState(Gates::andGate(_pins[7].getState(), _pins[8].getState()));
        ...
        case 10:
            ...
            _pins[10].setState(Gates::andGate(_pins[11].getState(), _pins[12].getState()));
