...
bool DroidMemory::operator==(DroidMemory droidmemory) const { return (_exp == droidmemory._exp && _fingerprint == droidmemory._fingerprint); }

bool DroidMemory::operator!=(DroidMemory droidMemory) const { return (!operator==(droidMemory)); }

bool DroidMemory::operator<(DroidMemory droidMemory) const { return (_exp < droidMemory._exp); }
...
bool DroidMemory::operator<(size_t exp) const { return (_exp < exp); }
