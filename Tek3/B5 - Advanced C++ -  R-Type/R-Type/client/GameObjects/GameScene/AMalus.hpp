...
namespace RType::ECS {
    class AMalus : public RType::ECS::GameObject<RType::ECS::ID, RType::ECS::Position, RType::ECS::SfmlDrawable> {
    public:
        explicit AMalus(RType::ECS::ID, RType::ECS::Position, RType::Network::Udp::ObjectType, RType::ECS::SfmlDrawable) noexcept;
