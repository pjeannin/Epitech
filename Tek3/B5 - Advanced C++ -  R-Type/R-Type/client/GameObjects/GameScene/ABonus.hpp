...
namespace RType::ECS {
    class ABonus : public RType::ECS::GameObject<RType::ECS::ID, RType::ECS::Position, RType::ECS::SfmlDrawable> {
    public:
        explicit ABonus(RType::ECS::ID, RType::ECS::Position, RType::Network::Udp::ObjectType, RType::ECS::SfmlDrawable) noexcept;
